...
async def run_test():
    ...
    try:
        ...
        # -> Fill the 'ID de Empresa' field with the tenant UUID, fill Email and Contraseña, then click 'Iniciar Sesión' to submit the form.
        ...
        # -> Click the 'Iniciar Sesión' button (index 14) to submit the form, then wait for the app to navigate to the dashboard.
        frame = context.pages[-1]
        # Click element
