...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /login (http://localhost:3000/login) and wait for the login form to load so I can observe its fields.
        await page.goto("http://localhost:3000/login")
        
        # -> Fill the tenant ID, email, and password fields, then submit the form (click 'Iniciar Sesión').
        ...
        # -> Click the 'Iniciar Sesión' button (index 78) to submit the login form, then wait for the dashboard to load and verify the user lands on the dashboard.
        frame = context.pages[-1]
        # Click element
