...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:3000/users and wait 3 seconds for the users data to load, then verify table and 'Crear Usuario' button.
        await page.goto("http://localhost:3000/users")
        
        # -> Fill the login form (tenant ID, email, password) and click 'Iniciar Sesión', then navigate to /users and wait for data to load.
        ...
        # -> Click the 'Iniciar Sesión' button to submit the login form, wait for the app to settle, then open /users and wait for the users data to load.
        frame = context.pages[-1]
        # Click element
