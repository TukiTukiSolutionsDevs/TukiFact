...
async def run_test():
    ...
    try:
        ...
        # -> Fill the tenant ID, email, and password fields, then submit the login form (click 'Iniciar Sesión').
        ...
        # -> Click the 'Iniciar Sesión' button (index 98) to submit the login form and then verify landing on /dashboard and presence of KPI summary cards and charts.
        frame = context.pages[-1]
        # Click element
