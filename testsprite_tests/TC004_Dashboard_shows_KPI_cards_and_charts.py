...
async def run_test():
    ...
    try:
        ...
        # -> Fill the tenant ID, email and password fields and click 'Iniciar Sesión'. Then wait for the app to redirect and settle so the dashboard can be verified.
        ...
        # -> Click the 'Iniciar Sesión' button (index 173) to submit the login form, then wait for the app to redirect and settle so the dashboard can be verified.
        frame = context.pages[-1]
        # Click element
