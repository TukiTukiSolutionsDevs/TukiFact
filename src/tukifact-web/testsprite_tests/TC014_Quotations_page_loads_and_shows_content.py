...
async def run_test():
    ...
    try:
        ...
        # -> Fill the 'ID de Empresa' field (element 11) with b2ba4cad-45c9-4a98-96f9-bf2eb6c96572 (then fill email and contraseña, submit).
        ...
        # -> Click the 'Iniciar Sesión' button (element 14) to submit the login form.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/form/div[2]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the 'Cotizaciones' link in the sidebar (element 273), wait 5 seconds for the page to render, then verify a heading containing 'Cotizaciones' and presence of either a table of quotation data or an empty-state message.
        frame = context.pages[-1]
        # Click element
