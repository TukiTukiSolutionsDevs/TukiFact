...
async def run_test():
    ...
    try:
        ...
        # -> Fill 'ID de Empresa' with the provided UUID in the tenantId field (index 13).
        ...
        # -> Click 'Iniciar Sesión' (element 16), wait up to 10 seconds for the app to reach /dashboard, then navigate to /documents/new and wait 5 seconds for the page to settle to perform the verifications.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/form/div[2]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        await page.goto("http://localhost:3001/documents/new")
