...
async def run_test():
    ...
    try:
        ...
        # -> Fill the 'ID de Empresa' field with the provided tenant UUID.
        ...
        # -> Click the 'Iniciar Sesión' button to submit the login form (element index 11), wait for the app to redirect, then navigate to /series and check for 'Series', 'F001' and 'B001' on that page.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/form/div[2]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        await page.goto("http://localhost:3001/series")
